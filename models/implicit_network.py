...
class ImplicitNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        x = input # 66536, 198
        print('2',round(x.min().item(),2),round(x.max().item(),2))
    ...
    def get_outputs(self, x, iseval=False):
        ...
        # output [32768, 257]
        print('0',round(output.min().item(),2),round(output.max().item(),2))
        sdf = output[:,:1]
        print('1',round(sdf.min().item(),2),round(sdf.max().item(),2))
